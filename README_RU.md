...
- **hillhorn_mcp_server.py** — точ позиции MCP, регистрирует инструменты и обрабатывает вызовы.
...
NWF (Neuro-Weight Fields) основана на теории нейровесовых полей.

**Автор теории:** Роман Белоусов — создатель теории нейровесовых полей.
